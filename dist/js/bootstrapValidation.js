...
(function (global, factory) {
    ...
    class BootstrapValidation {
        ...
        _initField(field) {
            ...
            fields.each((index, fieldElement) => {
                ...
                // 得到错误消息容器Jq对象
                let $message = (container && container !== 'tooltip' && container !== 'popover') ? $$1(container) : this._getMessageContainer($field, group);
            ...
            switch (this.options.live) {//判断验证模式
                ...
                default:
                    ...
                    fields.off(events).on(events, function () {
                        if (that._exceedThreshold($$1(this))) { //检测是否超过阈值
        ...
        _getMessage(field, validatorName) {
            if (!this.options.fields[field] || !$$1.fn.bootstrapValidation.validators[validatorName]
        ...
        getFieldElements(field) {
            if (!this._cacheFields[field]) {
                this._cacheFields[field] = (this.options.fields[field] && this.options.fields[field].selector)
                    ? $$1(this.options.fields[field].selector)
                    ...
                    (function (f) {
                        ...
                        if (fields.length) {
                            let type = $$1(fields[0]).attr('type'),
                                event = ('radio' === type || 'checkbox' === type || 'file' === type || 'SELECT' === $$1(fields[0]).get(0).tagName) ? 'change' : that._changeEvent,
                            ...
                            fields.off(events).on(events, function () {
                                if (that._exceedThreshold($$1(this))) {
                                    that.validateField($$1(this));
                                }
                            });
                        }
    ...
    // 定义插件
    $$1.fn.bootstrapValidation = function (option) {
        //获取参数
    ...
    $$1.fn.bootstrapValidation.Constructor = BootstrapValidation;
    $$1.fn.bootstrapValidation.VERSION = Constants.VERSION;
    $$1.fn.bootstrapValidation.defaults = BootstrapValidation.DEFAULTS;
    $$1.fn.bootstrapValidation.validators = Rules;
    $$1.fn.bootstrapValidation.i18n = {};
    $$1.fn.bootstrapValidation.utils = Utils;

    return BootstrapValidation;

}));
//# sourceMappingURL=bootstrapValidation.js.map
